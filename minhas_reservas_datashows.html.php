        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col col-12">
                    ...
                    $check  = mysqli_query($con,"SELECT data_shows.*, reservas.* FROM reservas as reservas INNER JOIN data_shows as data_shows  on reservas.id_objeto = data_shows.id and reservas.matricula = $id_user and reservas.id_tipo = $tipo_reserva");
                    $valor = mysqli_num_rows($check);
                    if( $valor == 0){
                        echo "<h3> Não itens reservados  $valor </h3>";
                    }else{
                        echo "<tr><td>Marca:</td>";
